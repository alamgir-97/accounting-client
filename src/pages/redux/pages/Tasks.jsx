...
// import MyTasks from '../pages/redux/tasks/MyTasks';
// import TaskCard from '../pages/redux/tasks/TaskCard';
      ...
      <div className="col-span-9 px-10 pt-10">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-5">
            ...
            {/* <Modal isOpen={isOpen} setIsOpen={setIsOpen} title={'Programming Hero1'}>This is a modal1</Modal> */}
             <AddTaskModal isOpen={isOpen} setIsOpen={setIsOpen}></AddTaskModal>
  
         
          {/* <button onClick ={()=>setIsOpen2(!isOpen2)} className="btn btn-primary">Add Task2</button>
            <AddTaskModal2 isOpen={isOpen2} setIsOpen={setIsOpen2}></AddTaskModal2>
            <Modal isOpen={isOpen2} setIsOpen={setIsOpen2} title={'Programming Hero2'}>This is a modal2</Modal>  */}
