...
const StructuralEngineering = () => {
    return (
        ...
        <div className="bg-white">
          ...
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/playlist?list=PLUU3EzfPr915ebZONvUVHKm8Bls6D7EgA" target="_blank" rel="noreferrer">Harvard Model Bridge Testing! Trusses and Beams</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=KJdIbCn4NuE" target="_blank" rel="noreferrer">How Trusses Work! (Structures 5-1)</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/shorts/nmjQ0M3ByRc" target="_blank" rel="noreferrer">Types of structural roof trusses</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=Hn_iozUo9m4" target="_blank" rel="noreferrer">Understanding and Analysing Trusses</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=PXzSyKq7wdU" target="_blank" rel="noreferrer">6 Basic Procedure in Structural Design</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/shorts/uycXf0ipdi4" target="_blank" rel="noreferrer">Structural Design Patterns(Adopter, Decorater, Proxy)</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=sOBkmxRQaoI" target="_blank" rel="noreferrer">Top 05 Structural Design & Analysis Software For Civil Engineers</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.coohom.com/2D-Design-Tool/?utm_source=googlead&utm_medium=cpc&utm_campaign=B2C_PMAX_AI_Global_EN_20240328&campaignid=21132771285&adgroupid=&adid=&utm_term=&utm_campaign=&utm_source=googlead&utm_medium=ppc&hsa_acc=7381023625&hsa_cam=21132771285&hsa_grp=&hsa_ad=&hsa_src=x&hsa_tgt=&hsa_kw=&hsa_mt=&hsa_net=adwords&hsa_ver=3&gclid=Cj0KCQjwir2xBhC_ARIsAMTXk86-Fjtp9Bic88zxQ8BLK6AZw2mUUAwcG4CJc6Nat7M99vwIDXol1kwaAgBLEALw_wcB" target="_blank" rel="noreferrer">Coohom.com</a></button>
          </div>


          
          <div className="m-4 p-8">
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=4-7RV1HKIdo" target="_blank" rel="noreferrer">How to create construction website with html css | Construction website</a></button>
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=CRmwGlhJS0Y" target="_blank" rel="noreferrer">Introduction to Structural Engineering Design Centre - SEDC Website</a></button>
          </div>
          
          <button className="h-max-[35vw] border rounded-lg bg-orange-300 p-4 md:p-6 m-4 text-base md:text-lg lg:text-2xl text-left"><a className='text-blue-800' href="https://www.youtube.com/watch?v=P8D6P-6KVNM" target="_blank" rel="noreferrer">Stateful vs Stateless Architecture - System Design Basics</a></button>
        </div>
    );
};
