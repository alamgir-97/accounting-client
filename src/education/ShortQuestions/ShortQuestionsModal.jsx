...
const ShortQuestionsModal = ({ questionKey = {questionKey}, answerKey = {answerKey}, children }) => {
  ...
  return (
    <div>
      ...
      >        
        <span className="text-md"> ছোট প্রশ্ন </span>
...
export default ShortQuestionsModal;
