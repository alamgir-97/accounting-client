...
import BackendProjectSetupAdvanced from "./BackendProjectSetupAdvanced";
...
import BackendDeployment from "./BackendDeployment";
import FrontendProjectDeployment from "./FrontendProjectDeployment";
import FrontEndProjectSetupV2 from "./FrontEndProjectSetupV2";

const WebDevelopment = () => {
  const [video, setVideo] = useState();
  // const [img, setImg] = useState();
  const [width, setWidth] = useState(
    "w-4/12 md:4/12 lg:3/12 border flex flex-col justify-left"
  );
    ...
    setVideo(
      <>
        ...
        <div className="flex flex-col m-8">
          ...
          <a
            className="font-xl border rounded-md bg-orange-300 px-8 py-4 m-2 text-blue-700 cursor-pointer font-semibold"
            href="https://www.youtube.com/watch?v=hoJmwEb92oc"
            target="_blank"
            rel="noreferrer"
          >
            ১০ দিনে ২৫ লাখ টাকা সেল চ্যালেঞ্জ - ক্লাস ০১ | Advanced eCommerce
  ...
  // VSCode
  const handleVSCode = () => {
    setVideo(<VSCodeSetup></VSCodeSetup>);
  };

  // frontend installation/setup
  const handleFrontEndSetup = () => {
    setVideo(<FrontEndProjectSetup></FrontEndProjectSetup>);
  };
  const handleFrontEndSetupV2 = () => {
    setVideo(<FrontEndProjectSetupV2></FrontEndProjectSetupV2>);
  };
  const handleFrontEndDeployment = () => {
    setVideo(<FrontendProjectDeployment></FrontendProjectDeployment>);
  };

  // backend installation/setup
  const handleBackendSetup = () => {
    setVideo(<BackendProjectSetup></BackendProjectSetup>);
  };

  const handleBackendSetupAdvnaced = () => {
    setVideo(<BackendProjectSetupAdvanced></BackendProjectSetupAdvanced>);
  };

  const handleBackendDeployment = () => {
    setVideo(<BackendDeployment></BackendDeployment>);
  };
  ...
  const handleTerminal = () => {
    setVideo(
      <>
      <div className="text-base p-8 m-8 border rounded-lg bg-sky-200">
        <h1 className="text-xl font-bold">cmd</h1>
        <p className="flex gap-2">Create Folder <pre className="bg-white"></pre></p>
        <p className="flex gap-2">Create Folder <pre className="bg-white">mkdir folder-name</pre></p>
        <p className="flex gap-2">Switch Folder <pre className="bg-white">cd folder-name</pre></p>        
        <p className="flex gap-2">Switch Drive <pre className="bg-white"></pre></p>
        <p className="flex gap-2">Switch Folder <pre className="bg-white"></pre></p>
        <p className="flex gap-2">Rename Folder <pre className="bg-white"></pre></p>
        <p className="flex gap-2">Rename File <pre className="bg-white"></pre></p>
        <p className="flex gap-2">Delete Folder <pre className="bg-white"></pre></p>
        <p className="flex gap-2">install any npm package <pre className="bg-white">npm install package-name</pre></p>
      </div>
      <div className="text-xl font-bold p-8 m-8 rounded-lg bg-sky-200">powershell</div>
      <div className="text-xl font-bold p-8 m-8 rounded-lg bg-sky-200">git bash</div>
      <div className="text-xl font-bold p-8 m-8 rounded-lg bg-sky-200">windows terminal</div>
      <div className="text-xl font-bold p-8 m-8 rounded-lg bg-sky-200">hyper</div>
      <div className="text-xl font-bold p-8 m-8 rounded-lg bg-sky-200">iterm2</div>
  ...
  const handleVite = () => {
    setVideo(
      <>
        ...
        development experience for modern web projects. It is designed to be
        used with frameworks like React, Vue, and Svelte, and it leverages
        native ES modules in the browser to achieve fast hot module replacement
        (HMR) and quick builds.
      </>
    );
  };
  // flowbite
  const handleFlowbite = () => {
    setVideo(
      <>
        Flowbite is a ...
      </>
  ...
  // react-helmet-async
  const handleHelmetAsync = () => {
    setVideo(
      <>
        react-helmet-async is a ...
      </>
    );
  };
  // react-parallax
  const handleReactParallax = () => {
    setVideo(
      <>
        react-parallax is a ...
      </>
  ...
  const handleParallaxComponent = () => {
    setVideo(
      <>
        react-parallax-component is a ...
      </>
    );
  };
  // react-parallax-tilt
  const handleReactParallaxTilt = () => {
    setVideo(
      <>
        react-parallax-tilt is a ...
      </>
    );
  };
  // react-tabs
  const handleReactTabs = () => {
    setVideo(
      <>
        react-tabs is a ...
      </>
  ...
  // react-fontAwesome
  const handleFontAwesome = () => {
    setVideo(
      <>
        react-fontAwesome is a ...
      </>
    );
  };
  // remix
  ...
  // reactDatepicker
  const handleReactDatepicker = () => {
    setVideo(
      <>
        reactDatepicker is a ...
      </>
    );
  };
  // reactPdf
  const handleReactPdf = () => {
    setVideo(
      <>
        reactPdf is a ...
      </>
  ...
  // firebase Hosting
  const handleFirebaseHosting = () => {
    setVideo(
      <>
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
          <h1 className="text-3xl text-center font-bold">Firebase Hosting</h1>
          ...
          <li>
            DANGER: Do not publish or make firebase config to public by pushing
            those to github{" "}
          </li>
          <li>go to docs&gt;build&gt;authentication&gt;Web&gt;Get Started</li>
          <li>add config file to the project</li>
          <li className="bg-pink-700">
            How to set custom firebase domain name (custom-site-id.web.app)?
          </li>
          <li>
            Solution: Register app&gt;Add set up Firebase Hosting to this
            app&gt;Create a new site
          </li>
  ...
  const handleFirebaseAuthentication = () => {
    setVideo(
      <>
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
    ...
    setVideo(
      <>
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
          ...
          <li>brandcolor</li>
          <li>
            <a href="http://www.coolors.co">coolors.co</a>
          </li>
          <li>themeforest</li>
          <li>
            <a href="https://wedevs.com">wedevs.com</a>
          </li>
        ...
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
          <div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-bold text-xl text-bl"
            >
              npm i prop-types
            </a>
          </div>
          ...
          <p>
            <b>Step-2: use proptypes </b>
            {`MyComponent.propTypes = { children: PropTypes.node }`}
          </p>

          <div className="hidden">
            <li className="bg-red-600 text-white border m-1 text-lg pl-2 font-bold">
              List of Relatives
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Riya
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Rashed
  ...
  const handleVercel = () => {
    setVideo(
      <>
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
          <div className="">
            <h1 className="bg-red-600 text-white border m-1 text-xl pl-2 font-bold">
              Deploy Backend in Vercel
            </h1>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-1: Deploy Frontend (in Firebase) and create live link
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-2: Create vercel.json file
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-3: Frontend hosting URLs for cors if cookies are used
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-4: Vercel --prod
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              ...
              (vercel&gt;my-server-app&gt;settings)
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-6: In Frontend folder replace all localhost by newly created
    ...
    setVideo(
      <>
        <div className="h-[80vh] bg-sky-200 border p-6 m-2">
          <div className="">
            <h1 className="bg-red-600 text-white border m-1 text-xl pl-2 font-bold">
              Action, Dispatch, Payload, Reducer, Store
            </h1>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-1: Create a react project or use and existing react project
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-2: Install redux toolkit and react-redux
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-3: Setup a store (import configureStore from @reduxjs/ttolkit
              and later import slice to connect with slice )
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-4: Create Slice (import createSlice from@reduxjs/toolkit and
              export the slice.reducer and and the actions)
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-5: Wrap main.jsx with Provider (to make availabe store to all
              components)
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-6: import useSelector from react-redux to consume state in
              the Component
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-7: import actions from the slice/slices
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              Step-8: import useDispatch from react-redux to trigger actions in
              the Component
            </li>
            <li className="bg-red-600 text-white border m-1 text-lg pl-2">
              middleware
  ...
  return (
    <div className="mx-auto bg-white">
      ...
      <div className="flex text-xs md:text-sm lg:text-base">
        <div className={width}>
          <button
            // onClick={()=>{setWidth("w-4/12 md:4/12 lg:3/12 border flex flex-col justify-left")}}
            onClick={handleWidth}
            onDoubleClickCapture={handleWidth2}
            className="rounded-md w-[8vh] md:w-[16vh] h-[4vh] md:h-[8vh] border px-1 md:px-1 ml-6 md:ml-8 lg:ml-12 my-2 md:my-3 bg-gray-600 md:bg-gray-500 lg:bg-gray-400  text-white font-bold"
          >
            Change Width &lt; &gt;{" "}
          </button>
          ...
          <button
            ...
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-emarald-400 md:bg-emerald-500 lg:bg-emarald-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            Web Development
          </button>
          ...
          <button
            onClick={handleFrontEndSetupV2}
            onDoubleClickCapture={handleVideo1}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            Frontend Project Setup V2
          </button>
          <div className="divider"></div>
          <button
            onClick={handleFrontEndDeployment}
          ...
          <div className="divider"></div>
          <button
            onClick={handleFirebaseAuthentication}
            onDoubleClickCapture={handleVideo3}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
          ...
          <button
            onClick={handleParallaxComponent}
            onDoubleClickCapture={handleVideo3}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            React Parallax Component
          ...
          <button
            onClick={handleReactParallaxTilt}
            onDoubleClickCapture={handleVideo3}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            React Parallax tilt
          ...
          <div className="divider"></div>
          <div className="text-center font-bold">Backend</div>
          <div className="divider"></div>
          <button
          ...
          <button
            onClick={handleBackendSetupAdvnaced}
            onDoubleClickCapture={handleVideo2}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            Backend Project Setup /Installation (Advanced)
          </button>
          <div className="divider"></div>
          <button
            onClick={handleBackendDeployment}
            onDoubleClickCapture={handleVideo2}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
          ...
          <div className="divider"></div>
          <div className="text-center font-bold">Hosting</div>
          <div className="divider"></div>
          <button
          ...
          <div className="divider"></div>
          <div className="text-center font-bold">Mail and Message</div>
          <div className="divider"></div>

          <button
            onClick={handleReactMailer}
            onDoubleClickCapture={handleVideo3}
            className="h-[8vh] md:h-[12vh] border px-2 md:px-3 mx-3 md:mx-4 lg:mx-6 my-2 md:my-3 bg-amber-400 md:bg-emerald-500 lg:bg-fuchsia-600 lg:focus:bg-fuchsia-700 lg:text-white font-bold"
          >
            ReactMailer
          ...
          <button className="h-[12vh] border-gray-400 bg-amber-200">
            <p>
              <span className="font-semibold w-full">Developer:</span> Md.
              Alamgir
            </p>
            <p>
              <span className="font-semibold w-full">Contact:</span>{" "}
              01817-796141
            </p>
          </button>
        </div>
