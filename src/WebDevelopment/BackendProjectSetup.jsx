        ...
        <div className="p-5 mb-[50vh]">
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                terminal-এ mkdir দিয়ে folder create করা যায়। myapp হল folder-এর
                নাম। আপনি নতুন যে backend project তৈরী করতে চাচ্ছেন এই কমান্ড
                ব্যবহার করে সেটি তৈরী করুন। আপনার প্রয়োজন অনুযায়ী আপনি যে কোন
                valid নাম দিতে পারেন।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            <div className="mockup-code w-[35vw] h-[20vh] border -ml-4 pl-6">
              ...
              <pre data-prefix="$">
                <code>cd /{<span className="text-rose-800">myapp</span>} </code>
              </pre>
            </div>
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                ...
                নিজে না দিয়ে auto যেন নিয়ে নেয় সেজন্য -y অংশটুকু দিতে হয়।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                package.json ফাইলের মধ্যে script: এর ভিতরে &quot;start&ldquo;:
                nodemon index.js, অংশটুকু টাইপ করতে হবে। এর অর্থ হল backend-এর
                কোডগুলো index.js ফাইলে রাখা হবে এবং nodemon দিয়ে development
                গুলো monitor করা হবে।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                root folder-এ index.js নামে একটি ফাইল create করাতে হবে। এই ফাইলে
                ‍server-side কোডগুলো থাকবে।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                express, mongodb, cors এবং dotenv ইন্সটল করার জন্য এই লাইনটি
                terminal/cmd-তে ব্যবহার করতে হবে।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                middleware হিসাবে cors middleware-কে import করার জন্য index.js
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                .gitignore ফাইল ক্রিয়েট করার জন্য root folder-এ এই লাইনটি
                ক্রিয়েট করতে হবে।
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            ...
            <div className="w-[35vw] h-[20vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                node_modules ফোল্ডারটি যেন github -এ কপি না হয় সেজন্য
                .gitignoreফাইলে node_modules অংশটুকু লিখতে হবে।
              </p>
            </div>
          </div>
...
{/* ======================******======================== */}
          <div className="flex justify-left relative p-4 bg-sky-300 mb-4">
            <div className="mockup-code w-[35vw] h-[200vh] border -ml-4 pl-6">
              <code className="w-42 absolute -top-2 left-0 bg-gray-800 pl-3 pr-20 py-2 border-b-2 border-sky-400 text-lg">
                terminal
              </code>
              <pre data-prefix="$">
             ...
             <p><code> const port = process.env.PORT || 5000;</code></p>
             <br></br>
             <p><code className="bg-stone-500"> {`//middleware`}</code></p>
             <p> <code> app.use(cors());</code></p>
             <p><code> app.use(express.json());</code></p>
             <br></br>
             <br></br>
             <p><code> {`app.get('/', (req, res) =>{`}</code></p>
             <p><code> {`res.send('SIMPLE CRUD IS RUNNING')`}</code></p>
             <p><code> {`})`}</code></p>
             <br></br>
             <p><code> {`app.listen(port, () =>{`}</code></p>
             <p> <code> {`console.log(&backprime;SIMPLE CRUD is running on port,  $ {port}   &backprime;)  `}</code> </p>
             <p><code> {`})`}</code></p>
              </pre>
            </div>
            <div className="w-[35vw] h-[200vh] border -ml-4 pl-6">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 p-4">
                backend প্রজেক্ট ‍starting code
              </p>
            </div>
          </div>
        </div>
