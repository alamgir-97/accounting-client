...
const HTMLComponent = () => {
 ...
 <p> I can be a React component, multiple React components, or just some text.</p> <img src="/public/blue-car.webp" className="h-20"></img>
          ...
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line1">&lt;!DOCTYPE html&gt;</p></div><button onClick={()=>handleCopyContent('line1')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          ...
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line2">&lt;html lang=&quot;en&ldquo;&gt;&lt;/html&gt;</p></div><button onClick={()=>handleCopyContent('line2')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line2">&lt;html dir=&quot;ltr&ldquo; lang=&quot;en&ldquo;&gt;&lt;/html&gt;</p></div><button onClick={()=>handleCopyContent('line2')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line2">&lt;html lang=&quot;bn&ldquo;&gt;&lt;/html&gt;</p></div><button onClick={()=>handleCopyContent('line2')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          ...
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line56">&lt;input type=&quot;text&ldquo; name=&quot;text&ldquo; defaultValue=&quot;default&ldquo; &gt;&lt;/input&gt;</p></div><button onClick={()=>handleCopyContent('line56')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div> 
          ...
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta charset=&quot;UTF-8&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta name=&quot;description&ldquo; content=&quot;Free HTML tutorials for beginners&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta name=&quot;keywords&ldquo; content=&quot;HTML, tutorials, beginners&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta name=&quot;author&ldquo; content=&quot;Md. Alamgir&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta name=&quot;viewport&ldquo; content=&quot;width=device-width, initial-scale=1.0&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;refresh&ldquo; content=&quot;30&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;refresh&ldquo; content=&quot;5, url=http://www.google.com&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;robots&ldquo; content=&quot;noindex&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;robots&ldquo; content=&quot;nofollow&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;robots&ldquo; content=&quot;none&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;robots&ldquo; content=&quot;max-snippet: 200&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
          <div className="flex justify-between p-1"><div className="flex"><input type="checkbox" className="checkbox" checked/><p className='pl-4' id="line117">&lt;meta http-equiv=&quot;robots&ldquo; content=&quot;index, follow&ldquo;&gt;&lt;/meta&gt;</p></div><button onClick={()=>handleCopyContent('line1117')}  className="border bg-fuchsia-600 text-white hover:border-fuchsia-800 rounded-md py-2 pl-4 pr-6 font-bold">Copy</button></div>
